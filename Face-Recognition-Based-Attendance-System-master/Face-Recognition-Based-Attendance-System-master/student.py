...
#         # # first image
        ...
        img1 = img1.resize((550, 130), Image.Resampling.LANCZOS)  #setting size and conver hight level image to low level
...
#         # second image
        img2 = Image.open(r"C:\Users\ACER\OneDrive\Desktop\final year project\Facial-Recognition-Based-Student-Attendance-System-main\Images/stu2.jpg")
...
#         # # third image
    ...
    #Background image 
        ...
        title_lbl=Label(bg_img,text="STUDENT DETAILS MANAGEMENT",font=("Algerian",30,"bold"),bg="white",fg="black")
        ...
        img_left = Image.open(r"C:\Users\ACER\OneDrive\Desktop\final year project\Facial-Recognition-Based-Student-Attendance-System-main\Images/scolar.jpg")
        img_left = img_left.resize((720,130),Image.Resampling.LANCZOS)  #Resampling.LANCZOS lea high level image lai low level mah convert garxa
        ...
        dep_combo["values"]=("Select Department","IT","Computer","Civil","Elx & Comm","Mechanical")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","B.tech","M.tech","BSc","BCA","MCA")
    ...
    #button frame
        ...
        save_btn=Button(btn_frame,text="Add",command=self.add_data,width=17,font=("times new roman",13,"bold"),bg="Green",fg="white")
    ...
    #frame for take photo and update photo
        ...
        btn_frame1.place(x=0,y=247,width=715,height=35)

        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=35,font=("times new roman",13,"bold"),bg="green",fg="white")
        ...
        img_right = Image.open(r"C:\Users\ACER\OneDrive\Desktop\final year project\Facial-Recognition-Based-Student-Attendance-System-main\Images/student.jpg")
        img_right = img_right.resize((720,130),Image.Resampling.LANCZOS)  #Resampling.LANCZOS lea high level image lai low level mah convert garxa
...
##Search System
        ...
        search_label=Label(search_frame,text="Search By:",font=("times new roman",13,"bold"),bg="brown",fg="white")
        search_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        search_combo=ttk.Combobox(search_frame,textvariable=self.var_search,font=("times new roman",13,"bold"),state="readonly",width=16)
 ...
 ####function decleration ######
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="Ashutosh@123",database="face_recogniser",auth_plugin="mysql_native_password")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,phone=%s,Address=%s,Teacher=%s,PhotoSample=%s,Student_id=%s where Student_id=%s",(
                ...
                face_classifier=cv2.CascadeClassifier(r'C:\Users\ACER\OneDrive\Desktop\final year project\Facial-Recognition-Based-Student-Attendance-System-main\haarcascade_frontalface_default.xml')
